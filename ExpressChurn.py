...
st.markdown("<h3 style = 'margin: -25px; color: #45474B; text-align: center;font-family: Arial, Helvetica, sans-serif; '> BUILT BY OLUKUNLE GODFIRST</h3>", unsafe_allow_html= True)
st.image('pngwing.com (8).png', width = 400)
